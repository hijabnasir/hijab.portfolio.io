...
//denne gøre  holde styr på de forskellige vægte der bliver fundet og deres index og finder den shortestpath
...
function dijkstra(matrix, startNode, endNode) {
	...
	distanceFromSource[startNode] = 0; //sætter = 0, fori vi vil start hvilken som helst sted. bruger dem også som indexholder.
										// for at stoppe dijkstra, når den har fundet slutnod
