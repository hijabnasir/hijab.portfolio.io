...
let expectedPixelsGreen0x13 = [
    ...
    //nonGreentest, den går og kigger 
export function nonGreenTest(listOfNodes, start, end, successfulTests, expected) {
    let matrix = createNonGreenAdjacencyMatrix(listOfNodes);
        //den tage alle først path som bliver returet fra dijkstra og oversætte til json string. 
        //tjekke det med expected og vores expected det vores array som giver korret result idenne tilfaldet.
